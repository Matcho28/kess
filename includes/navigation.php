...
function getNavigationIconSvg(string $key): string
{
    $icons = [
        ...
        'calendar' => '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M8 2a1 1 0 0 1 1 1v1h6V3a1 1 0 1 1 2 0v1h1a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3h1V3a1 1 0 0 1 1-1Zm-2 6a1 1 0 0 0 0 2h12a1 1 0 1 0 0-2H6Zm0 4a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H6Zm0 4a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2H6Z" fill="currentColor"/></svg>',
    ];
    ...
    if ($role === ROLE_SUPER_ADMIN) {
        return [
            ...
            [
                ...
                'items' => [
                    ['key' => 'roles', 'label' => 'Roles', 'path' => '/roles/index.php'],
                    ['key' => 'calendar', 'label' => 'Calendar', 'path' => '/modules/calendar/index.php']
                ]
            ],
